...
const Navbar = () => {
  return (
    <div className='bg-gray2 h-16 flex justify-between items-center pl-[150px] border px-10'>
      <span className='font-bold text-gray1 text-lg'>Default Company Dashboard</span>
      <div className='flex items-center space-x-5'>
        <Link href="/">
        <div className='border rounded-sm flex items-center space-x-2 py-1.5 px-2.5 bg-bg-gray3 hover:bg-gray5 duration-300'>
